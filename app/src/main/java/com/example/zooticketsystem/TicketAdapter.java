...
public class TicketAdapter extends RecyclerView.Adapter<TicketAdapter.MyViewHolder> {
    ...
    public TicketAdapter(Context c, ArrayList<MyTicket> tikets){
        context = c;
        myTicket = tikets;
    }
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.xjumalh_tiket.setText(myTicket.get(position).getJumlah_tiket() + " Ticket");
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent gotomyticketdetails = new Intent(context, MyTicketDetailsActivity.class);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        TextView xnama_wisata, xlokasi, xjumalh_tiket;
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            xjumalh_tiket = itemView.findViewById(R.id.xjumlah_tiket);
        }
    }
}
