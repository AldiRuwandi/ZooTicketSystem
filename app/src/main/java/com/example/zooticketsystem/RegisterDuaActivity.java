...
public class RegisterDuaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pic_photo_register_user = findViewById(R.id.pic_photo_regis_user);
        bio = findViewById(R.id.bio);
        nama_langkap = findViewById(R.id.nama_lengkap);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            storageReference1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    reference.getRef().child("nama_lengkap").setValue(nama_langkap.getText().toString());
                                    reference.getRef().child("bio").setValue(bio.getText().toString());
                                }
                            }).addOnCompleteListener(new OnCompleteListener<Uri>() {
                                @Override
                                public void onComplete(@NonNull Task<Uri> task) {
                                    Intent gotosuccess = new Intent(RegisterDuaActivity.this, SuccessRegisterActivity.class);
